        ...
        <div className="container my-4">
          ...
          <div className="text-center mb-5">
            ...
            <p className="text-muted fs-5">
              Soluciona todos tus problemas de optimización en una sola
              plataforma
            </p>
          </div>
                  ...
                  <li className="nav-item" role="presentation" key={tab.id}>
                    <button
                      ...
                      style={{
                        border: "none",
                        borderRadius:
                          activeTab === tab.id ? "15px 15px 0 0" : "0",
                        backgroundColor:
                          activeTab === tab.id ? "#fff" : "#f8f9fa",
              ...
              <div className="tab-content" id="optimizationTabContent">
                ...
                >
                  <div className="text-center mb-4">
                    <h3 className="text-primary">🧮 Programación Lineal</h3>
                    <p className="text-muted">
                      Optimiza funciones lineales con múltiples restricciones
                      usando métodos avanzados
                    </p>
                  </div>
                  <LinearPage />
                </div>
                ...
                >
                  <div className="text-center mb-4">
                    <h3 className="text-primary">📦 Problema de Transporte</h3>
                    <p className="text-muted">
                      Optimiza la distribución de productos desde orígenes a
                      destinos
                    </p>
                  </div>
                  <TransportPage />
                ...
                >
                  <div className="text-center mb-4">
                    <h3 className="text-primary">🌐 Optimización en Redes</h3>
                    <p className="text-muted">
                      Analiza grafos para encontrar rutas óptimas y flujos
                      máximos
                    </p>
                  </div>
                  <NetworkPage />
              ...
              <div className="card-body">
                ...
                <div className="text-center mt-4">
                  <div className="alert alert-info">
                    ...
                    <p className="text-muted">
                      Los análisis de sensibilidad se generan automáticamente en
                      cada módulo para proporcionar insights valiosos sobre la
